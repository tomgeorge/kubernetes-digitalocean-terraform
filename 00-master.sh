...
env
kubeadm init --ignore-preflight-errors=NumCPU --pod-network-cidr=10.244.0.0/16 --apiserver-advertise-address=${MASTER_PRIVATE_IP} --apiserver-cert-extra-sans="${MASTER_PUBLIC_IP}" --feature-gates "VolumeSnapshotDataSource=true"
